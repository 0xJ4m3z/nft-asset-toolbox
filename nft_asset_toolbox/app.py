...
class MainWindow(QMainWindow):
    ...
    def _dashboard_page(self) -> QWidget:
        ...
        self.activity_table.setTextElideMode(Qt.ElideRight)
        self.activity_table.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.activity_table.setColumnWidth(0, 122)
        self.activity_table.setColumnWidth(1, 130)
        self.activity_table.setColumnWidth(2, 66)
